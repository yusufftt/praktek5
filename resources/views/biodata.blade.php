...
<div class="w-full px-6 py-6 mx-auto">
  ...
  <div class="bg-white rounded-lg shadow-lg px-6 py-4">
    ...
    <p class="text-gray-700 text-base"><strong>Nama:</strong> Syaifullah Yusuf</p>
    <p class="text-gray-700 text-base"><strong>Tempat Tanggal Lahir:</strong> Singkawang, 28 Juni 2003</p>
    <p class="text-gray-700 text-base"><strong>Hobi:</strong> Renang</p>
  </div>
  <footer class="pt-4">
